...
void glueVars()
{
    ...
    int_output_ptr[1] = (IEC_UINT *)__QW1;
    
    int_output_ptr[4] = (IEC_UINT *)__QW4;
    
    int_output_ptr[5] = (IEC_UINT *)__QW5;
    
    int_output_ptr[0] = (IEC_UINT *)__QW0;
    
    int_output_ptr[3] = (IEC_UINT *)__QW3;
    
    int_output_ptr[2] = (IEC_UINT *)__QW2;
